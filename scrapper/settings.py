...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'admintask.context_processors.global_settings',
            ],
        },
    },
]
...
# Adds a cache-control: max-age=31536000, immutable header to static files
...
SESSION_COOKIE_AGE = 2592000  # 30 Days default for persistent sessions
